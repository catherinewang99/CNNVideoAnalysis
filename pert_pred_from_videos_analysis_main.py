...
from pert_pred_from_videos_analysis_exp import PertPredFromVideosAnalysisExp
import numpy as np
...
def parse_args():
    ...
    parser.add_argument('--plot_score_distribution', action='store_true', default=True)
    ...
    parser.add_argument('--sess_type_list', nargs='+', type=str, default=['left_stim'],\
     help='original_guang_one_laser, full_reverse_guang_one_laser, or original_and_full_reverse_guang_one_laser')
